...
export default function Game() {
  ...
  return (
    <main className="min-h-dvh h-dvh p-4 bg-gradient-to-br from-blue-100 via-purple-50 to-pink-100">
          ...
          <div className="fixed inset-0 z-50 grid place-items-center bg-black/40" role="dialog" aria-modal="true">
            <Card className="w-[min(92vw,480px)] p-5">
              ...
              <div className="mt-5 flex justify-end gap-2">
                <Button onClick={() => { setShowDetails(false); setSelected(null); }} variant="outline">Close</Button>
              </div>
            </Card>
          </div>
        )}
